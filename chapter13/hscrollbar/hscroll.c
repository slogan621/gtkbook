...
char *argv[];
{
  ...
  hscale = gtk_hscrollbar_new( GTK_ADJUSTMENT(adj1) );
  ...
  vscale = gtk_vscrollbar_new( GTK_ADJUSTMENT(adj2) );
  ...
  adj2 = (GtkObject *) gtk_range_get_adjustment( GTK_RANGE( vscale ) );

  printf( "adjustment 2 is %x\n", adj2 );
